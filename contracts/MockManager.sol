...
/// player
contract MockManager is AccessControl, ReentrancyGuard, VRFConsumerBase {
    ////////// CHAINLINK VRF v1 /////////////////
        ...
        public
    {
        ...
        transferNFTAndFunds(raffleId, normalizedRandomNumber);
    }
...
*/
    ...
    */
    ...
    /// @dev if the player is blacklisted, the method cancelEntry must be called by the operator
    /// to set to address(0) all the entries of that player
    /// @param _raffleId Id of the raffle
    ...
    // based on openzeppelin code (v4.0)
    ...
    function transferNFTAndFunds(
        uint256 _raffleId,
        uint256 _normalizedRandomNumber /*nonReentrant TODO remove comment when in production */
    ) internal {
        RaffleStruct storage raffle = raffles[_raffleId];
    ...
    function mockEarlyCashOut(uint256 _raffleId, uint256 _fakeRandomNumber)
        external
    {
        RaffleStruct storage raffle = raffles[_raffleId];
        FundingStructure memory funding = fundingList[_raffleId];
